...
export class HoverProvider implements vscode.HoverProvider {
  ...
  private isRaruiComponent(text: string): boolean {
    ...
    babelTraverse.default(ast, {
      ImportDeclaration(declarationPath) {
        ...
        if (importSource.startsWith("@rarui")) {
          ...
          importedSpecifiers.forEach((specifier) => {
            if (
              ...
              importComponent.isRaruiComponent = true;
            }
          });
        }
      },
    ...
    return importComponent.isRaruiComponent;
  }
