...
Install `@rarui-react/components` using any package manager.

```sh
$ yarn add @rarui-react/components
# or
$ npm install @rarui-react/components
```

## 💻 Usage

```jsx
import { Button } from "@rarui-react/components";
