...
export const backgroundColorProperties = {
  ...
  "on-brand-hover": varsThemeBase.colors.surface["on-brand-hover"],
  "on-brand-press": varsThemeBase.colors.surface["on-brand-press"],
  "on-error-hover": varsThemeBase.colors.surface["on-error-hover"],
  "on-error-press": varsThemeBase.colors.surface["on-error-press"],
  "on-info-hover": varsThemeBase.colors.surface["on-info-hover"],
  "on-info-press": varsThemeBase.colors.surface["on-info-press"],
  "on-success-hover": varsThemeBase.colors.surface["on-success-hover"],
  "on-success-press": varsThemeBase.colors.surface["on-success-press"],
  "on-warning-hover": varsThemeBase.colors.surface["on-warning-hover"],
  "on-warning-press": varsThemeBase.colors.surface["on-warning-press"],
